...
Zen has [a team of moderators](/wiki/People/Global_Moderation_Team) that keep the game and its ecosystem clean and safe. If you notice rule-breaking or inappropriate content, report it using one of the methods described below. Alternatively, you may contact us directly via a Discord ticket if your report wasn't properly handled within a reasonable amount of time — do so only as the last resort.
...
| Inappropriate conduct from a member of the [NAT](/wiki/People/Nomination_Assessment_Team) or [GMT](/wiki/People/Global_Moderation_Team) | [Account support team](/wiki/People/Account_support_team) via a Discord Ticket (make sure to select the staff abuse option, so only our administrators can view it.) |
